...
export default function UserBar() {
    return (
        <div className={`${manrope.className} relative z-10 px-6 text-black flex justify-between sm:h-16 h-14 w-full bg-white rounded-full`}>
            ...
            <div className={`${DMSans.className} text-nowrap w-full h-full flex gap-6 py-3 justify-end items-center`}>
                <p className={`${manrope.className} hidden lg:block text-gray-400`}>StudyBank</p>
                <p className={`${manrope.className} hidden lg:block text-gray-400`}>Find Tutor</p>
                <p className={`${manrope.className} hidden lg:block text-[#968191]`}>Homework</p>
                <Link href="/upload">
                    <p className={`${manrope.className} hover:text-fuchsia-800 hover:cursor-pointer`}>Upload</p>
                </Link>
                <button className="hidden lg:flex gap-2 rounded-full bg-[#FCF4EA] hover:bg-[#ffe9d1] py-2 px-3">
                ...
                <button className='hidden lg:block h-full w-fit px-4 rounded-xl bg-[#f0e0fa] hover:bg-[#e8cbf8] border border-[#A414D5]'>Refer a friend</button>
